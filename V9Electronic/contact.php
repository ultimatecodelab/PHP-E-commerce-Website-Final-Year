...
<head> 
    ...
    <title>Contact Us | V9-Electronics</title>
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<h2>V9 ***THIS WEBSITE WAS CREATED AS A COLLEGE PROJECT AND IS HOSTED FOR TESTING PURPOSE ONLY!!!
										 <br></h2>
...
$to = 'contacts@thecodingstuff.com'; // put your email
$email_subject = "Contact form submitted by:  $name";
$email_body = "You have received a new message. \n\n".
				  " Here are the details:\n \n Name: $name \n ".
				  "Email: $email_address\n Message \n $message";
$headers = "From: contacts@thecodingstuff.com\n";
